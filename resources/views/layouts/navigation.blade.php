<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(auth()->user()->role === 'admin' || auth()->user()->role === 'superuser')
                        ...
                        <x-nav-link :href="route('admin.approval.index')" :active="request()->routeIs('admin.approval.*')">
                            {{ __('Approval') }}
                        </x-nav-link>
                    ...
                    @else
                        <x-nav-link :href="route('karyawan.profile')" :active="request()->routeIs('karyawan.*')">
                            {{ __('Profile') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                <x-responsive-nav-link :href="route('karyawan.profile')" :active="request()->routeIs('karyawan.*')">
                    {{ __('Profile') }}
                </x-responsive-nav-link>
